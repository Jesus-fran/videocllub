@extends('index')
@section('content')
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="modalNuevoProveedor" tabindex="-1"
        aria-labelledby="modalNuevoProveedor" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('registrar-proveedor') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="modalNuevoProveedor">Nuevo proveedor</h1>
    ...
    <div class="row">
        <h1 class="gy-4 titulo text-dark">Proveedores</h1>
        <br>
    </div>
    <p class="text-light texto"></p>
    <br><br>
    <div class="col-12 text-end">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalNuevoProveedor">Registrar proveedor<i
    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
            ...
            @foreach ($proveedores as $proveedor)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('destroy-proveedor', ['id'=>$proveedor->id_prov]) }}">
        ...
        @if (sizeof($proveedores) == 0)
            <caption>No hay proveedores registrados</caption>
        @endif
